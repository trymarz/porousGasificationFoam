...
namespace Foam
{
    defineTypeNameAndDebug(basicPorousChemistryModel, 0);
}

// * * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * //

void Foam::basicPorousChemistryModel::correct()
{}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::basicPorousChemistryModel::basicPorousChemistryModel(const HGSSolidThermo& thermo)
:
    IOdictionary
    (
        IOobject
...
Foam::basicPorousChemistryModel::~basicPorousChemistryModel()
{}
